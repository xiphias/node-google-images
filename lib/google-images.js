...
exports.search = function(query, options) {
  ...
  return request("http://ajax.googleapis.com/ajax/services/search/images?v=1.0&hl=" + options.hl + "&q=" + (query.replace(/\s/g, '+')) + "&tbs=itp:photo&start=" + options.page, function(err, res, body) {
